...
function New-RBFE-stg1-VMs {
    ...
    $jobs = @()
    $jobs += New-PveVmFromTemplate -PveHost pve.tdm.local -UserName $UserName -VlanTag $VlanTag -Storage StudentVMS -TemplateId 301 -Credential $Credential -SkipCertificateCheck -Completion $Completion
    $jobs += New-PveVmFromTemplate -PveHost pve.tdm.local -UserName $UserName -VlanTag $VlanTag -Storage StudentVMS -TemplateId 302 -Credential $Credential -SkipCertificateCheck -Completion $Completion
    $jobs += New-PveVmFromTemplate -PveHost pve.tdm.local -UserName $UserName -VlanTag $VlanTag -NicCount 3 -Storage StudentVMS -TemplateId 303 -Credential $Credential -SkipCertificateCheck -Completion $Completion
    $jobs += New-PveVmFromTemplate -PveHost pve.tdm.local -UserName $UserName -VlanTag $VlanTag -NicCount 3 -Storage StudentVMS -TemplateId 304 -Credential $Credential -SkipCertificateCheck -Completion $Completion
    $jobs += New-PveVmFromTemplate -PveHost pve.tdm.local -UserName $UserName -VlanTag $VlanTag -NicCount 3 -Storage StudentVMS -TemplateId 305 -Credential $Credential -SkipCertificateCheck -Completion $Completion
