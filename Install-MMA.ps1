...
[string]$WorkspaceId = "092dfb6c-86d8-4346-bcb5-0abe05a9e33c"#<<< Enter your Workspace ID here
[string]$WorkspaceKey = "UjeQ1RA1beH+Jpd3zXpBuTugw6+gjJbC0UZ25f85yr9tW61wlXgyKtXo78kum/COr3oN2z5rqIG7CyP1/fy7Hw=="#<<< Enter your Workspace Key here
...
[string]$LocalFile = "\\Gondor\Admin\momagent.msi"
